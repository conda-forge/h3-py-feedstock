...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/h3-py-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/h3-py-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
It is possible to list all of the versions of `h3-py` available on your platform:
...
```
pixi search h3-py --channel conda-forge
```
